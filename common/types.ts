export enum BlockTypeEnum {
  ...
  SCHEDULE_LIST_TOGGLE_BY_TRACK_TALK_SINGAPORE = 'schedule-list-toggle-by-talk-track-iceland',
  SCHEDULE_LIST_BY_TRACK_SINGAPORE = 'schedule-list-by-track-iceland',
  SCHEDULE_LIST_BY_TALK_SINGAPORE = 'schedule-list-by-talk-iceland',
  SPEAKERS = 'speakers',
  TABLE = 'table',
  TEXT = 'text',
