...
import { FILECOIN_DEV_SUMMIT_2023_HERO_CONTENT, FILECOIN_DEV_SUMMIT_2023_PAGE_CONTENT, FILECOIN_DEV_SUMMIT_NAVIGATION_CONTENT } from '@root/content/filecoin-dev-summit';

export default async function Page(props) {
  const blocks = FILECOIN_DEV_SUMMIT_2023_PAGE_CONTENT;
  // const footerContent = FOOTER_FILTHING_CONTEN;
