...
export default function ScheduleIPFSCamp2024({ scheduleData, title }) {
  ...
  return (
    <div style={{ paddingBottom: '2rem', display: 'grid', rowGap: '3rem', zIndex: 'var(--z-index-large)', position: 'relative' }}>
      <div>
        {title && <h2 className={styles.scheduleTitle}>{title}</h2>}
        <p className={styles.mobileTooltip}>Scroll to see the full table</p>
