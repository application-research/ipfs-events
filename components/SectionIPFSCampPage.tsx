...
export default function SectionCamppage({ upcomingEvents, scheduleData }) {
  ...
  const faqsLeft = [
    ...
    {
      question: 'Childcare',
      answer: 'Childcare will be provided onsite to make this event more accessible to parents and caregivers. Please fill out the optional questions when you purchase your ticket on Luma. We will reach out to you for final RSVP by June 21.',
    },
  ];
...
This is a decentralized event, with over 15 tracks across 3 days. Explore the track descriptions and schedules, and choose your own adventures depending on your interests!
      ...
      You can: [Submit a track or talk](https://airtable.com/appM094R1Ma5HG757/shrWn6XaRgUkYWPm3), [Sponsor](https://airtable.com/appM094R1Ma5HG757/shrXTUagRUI1aC4G1), [Apply as an IPFS Scholar](https://airtable.com/appM094R1Ma5HG757/shrQGQ8gH7OUXdUuc), [Volunteer](mailto:camp@ipfs.io?subject=Volunteer), or tell a friend!
    },
